...
import com.acgameshyd.oneg.databinding.ActivityGameHomenBinding
import com.acgameshyd.oneg.EXTRA_GAME_NAM
import com.acgameshyd.oneg.LeaderBoard
import com.acgameshyd.oneg.MainGame
import com.acgameshyd.oneg.OwnGame
import com.acgameshyd.oneg.models.BoardSize
...
class GameHome : AppCompatActivity() {
    ...
    private lateinit var bind: ActivityGameHomenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bind= ActivityGameHomenBinding.inflate(layoutInflater)
    ...
    fun donw(view: View) {
        ...
        var v=LayoutInflater.from(this).inflate(R.layout.gnamen,null)
