...
import com.acgameshyd.oneg.databinding.ActivityOwnGamenBinding
...
class OwnGame : AppCompatActivity() {
    lateinit var bind: ActivityOwnGamenBinding
...
private    var imguris= mutableListOf<Uri>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        bind= ActivityOwnGamenBinding.inflate(layoutInflater)
...
companion object{
    ...
    private   var PIC_PER= Manifest.permission.READ_EXTERNAL_STORAGE
...
var i=Intent(Intent.ACTION_PICK)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode!= GET_PICS ||resultCode!= RESULT_OK ||data==null)
